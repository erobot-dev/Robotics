...
void loop() {
//  Serial.print("Value: ");
//  Serial.println(NRF_Control());
//NRF_Control();
  
  Motor_Control1(NRF_Control(), 250);
  //Servo_Control();
  if (NRF_Control() == '1' || NRF_Control() == '2' || NRF_Control() == '3' || NRF_Control() == '4'|| NRF_Control() == 'S') {
//    Servo_Rotate(NRF_Control());
    Servo_UpDown(NRF_Control());
    Servo_Shoot(NRF_Control());
  }
  //  Motor_Control('L',250);
  //LED_SHOW();
  //BUZZER_SHOW(50,4);
